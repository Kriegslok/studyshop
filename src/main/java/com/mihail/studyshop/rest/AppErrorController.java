...
public class AppErrorController implements ErrorController {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> error(ServletWebRequest request) {
        Map<String, Object> body = getErrorAttributes(request, getTraceParameter(request.getRequest()));
        HttpStatus status = getStatus(request.getRequest());
    ...
    private Map<String, Object> getErrorAttributes(ServletWebRequest request,
